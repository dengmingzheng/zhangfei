...
@section('content')
    <div class="header_line">
        ...
        <ul class="tab-base">
            ...
            <li><a href="{{url('admin/roles/create')}}"><span>添加角色</span></a></li>
        </ul>
    </div>

    <div class="content-group">

        <form method="post" id="form_station">
            ...
            <table class="table tb-type2 nobdb">
                ...
                @forelse($roles as $value)
                    <tr class="hover" style="background: rgb(255, 255, 255);">
                        ...
                        <td class="align-center">{{$value['role_name']}}</td>

                        <td class="align-center">{{$value['updated_at']}}</td>
                        <td class="align-center">{{$value['created_at']}}</td>

                        <td class="align-center">
                            <a href="{{url('admin/roles/edit?id=')}}{{$value['id']}}">编辑</a> |
                            <a href="JavaScript:void(0)" deleteId="{{$value['id']}}" deleteUrl="{{url('admin/roles/del')}}" class="delete">删除</a></td>
                    </tr>
                ...
                <tr>
                    ...
                    <td colspan="16"><label for="checkallBottom">全选</label>&nbsp;&nbsp;
                        <a href="JavaScript:void(0);" class="btn delAll"><span>删除</span></a>
