...
@section('content')
    <div class="header_line">
        ...
        <ul class="tab-base">
            ...
            <li><a href="{{url('admin/articleClasses/create')}}"><span>添加文章分类</span></a></li></ul>
    </div>
        ...
        <form method="get" name="formSearch" id="formSearch">
            ...
            <table class="tb-type1 noborder search">
                ...
                <tr>
                    ...
                    <td><a class="btns" id="searchReset" resetUrl="{{URL('admin/articleClasses')}}"><span>重置</span></a></td>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <table class="table tb-type2 nobdb">
                ...
                @forelse($list as $value)
                    <tr class="hover" style="background: rgb(255, 255, 255);">
                        ...
                        <td class="align-center">{{$value['parent'] ? $value['parent']['title'] : '顶级分类'}}</td>
                        ...
                        <td class="align-center">
                            <a href="{{url('admin/articleClasses/edit?id=')}}{{$value['id']}}">编辑</a> |
                            <a href="JavaScript:void(0)" deleteId="{{$value['id']}}" deleteUrl="{{url('admin/articleClasses/del')}}" class="delete">删除</a></td>
                    </tr>
                ...
                <tr>
                    ...
                    <td colspan="16"><label for="checkallBottom">全选</label>&nbsp;&nbsp;
                        <a href="JavaScript:void(0);" class="btn delAll" deleteUrl="{{url('admin/articleClasses/del')}}"><span>删除</span></a>
